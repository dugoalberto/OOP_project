...
# Project:  Project.pro
# Template: app
# Command: /Users/albertodugo/Qt/6.2.4/macos/bin/qmake -o Makefile Project.pro CONFIG+=sdk_no_version_check
#############################################################################
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /Users/albertodugo/Qt/6.2.4/macos/bin/qmake -install qinstall
QINSTALL_PROGRAM = /Users/albertodugo/Qt/6.2.4/macos/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
...
DIST          = ../../Qt/6.2.4/macos/mkspecs/features/spec_pre.prf \
		...
		../../Qt/6.2.4/macos/mkspecs/modules/qt_lib_core5compat.pri \
		../../Qt/6.2.4/macos/mkspecs/modules/qt_lib_core5compat_private.pri \
...
EXPORT__PRO_FILE_ = /Users/albertodugo/Desktop/Project/Project.pro


include /Users/albertodugo/Qt/6.2.4/macos/mkspecs/features/mac/sdk.mk
first: all
####### Build rules

Project.app/Contents/MacOS/Project:  $(OBJECTS)  
	@test -d Project.app/Contents/MacOS/ || mkdir -p Project.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Project.pro ../../Qt/6.2.4/macos/mkspecs/macx-clang/qmake.conf ../../Qt/6.2.4/macos/mkspecs/features/spec_pre.prf \
		../../Qt/6.2.4/macos/mkspecs/features/device_config.prf \
		../../Qt/6.2.4/macos/mkspecs/common/unix.conf \
		../../Qt/6.2.4/macos/mkspecs/common/mac.conf \
		../../Qt/6.2.4/macos/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile Project.pro CONFIG+=sdk_no_version_check
...
Project.app/Contents/Info.plist: 
	...
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.Project,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.Project,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},10.14,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,Project,g" -e "s,@LIBRARY@,Project,g" -e "s,\$${EXECUTABLE_NAME},Project,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" ../../Qt/6.2.4/macos/mkspecs/macx-clang/Info.plist.app >Project.app/Contents/Info.plist

all: Makefile \
		Project.app/Contents/PkgInfo \
		Project.app/Contents/Resources/empty.lproj \
		Project.app/Contents/Info.plist Project.app/Contents/MacOS/Project
...
distdir: FORCE
	...
	$(COPY_FILE) --parents main.cpp cmake-build-debug/Project_autogen/mocs_compilation.cpp cmake-build-debug/CMakeFiles/3.21.1/CompilerIdC/CMakeCCompilerId.c cmake-build-debug/CMakeFiles/3.21.1/CompilerIdCXX/CMakeCXXCompilerId.cpp $(DISTDIR)/
...
mocs_compilation.o: cmake-build-debug/Project_autogen/mocs_compilation.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mocs_compilation.o cmake-build-debug/Project_autogen/mocs_compilation.cpp

CMakeCCompilerId.o: cmake-build-debug/CMakeFiles/3.21.1/CompilerIdC/CMakeCCompilerId.c 
	$(CC) -c $(CFLAGS) $(INCPATH) -o CMakeCCompilerId.o cmake-build-debug/CMakeFiles/3.21.1/CompilerIdC/CMakeCCompilerId.c

CMakeCXXCompilerId.o: cmake-build-debug/CMakeFiles/3.21.1/CompilerIdCXX/CMakeCXXCompilerId.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o CMakeCXXCompilerId.o cmake-build-debug/CMakeFiles/3.21.1/CompilerIdCXX/CMakeCXXCompilerId.cpp
